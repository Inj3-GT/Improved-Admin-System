...
Admin_System_Global.Ticket_Cmd = "!ticket" --- // Panel pour générer un ticket, inclure votre commande ici (ne pas inclure ///, celui-ci est déjà inclu automatiquement via la variable ci-dessus "Admin_System_Global.OverrideOpenTick").
